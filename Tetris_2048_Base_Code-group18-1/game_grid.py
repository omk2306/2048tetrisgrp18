...
class GameGrid:
   ...
   def display(self):
      ...
      stddraw.text(self.game_width + 4.5, self.grid_height - 5, "HOW TO PLAY")
      stddraw.text(self.game_width + 4.5, self.grid_height - 5.2, "------------------------")
      stddraw.text(self.game_width + 1.5, self.grid_height - 7, "→ ")
      stddraw.text(self.game_width + 7, self.grid_height - 7, "MOVE RIGHT")
      stddraw.text(self.game_width + 1.5, self.grid_height - 8, "← ")
      stddraw.text(self.game_width + 7, self.grid_height - 8, "MOVE LEFT")
      stddraw.text(self.game_width + 1.5, self.grid_height - 9, "↑")
      stddraw.text(self.game_width + 7, self.grid_height - 9, "ROTATING")
